...
const Dashbord = () => {
    ...
    const fetchDashboardData = async () => {
        try {
            const {data} = await axios.get('/api/bookings/place', { headers: { Authorization: `Bearer ${await getToken()}` } }  )
            if (data.success) {
            ...
            <div className='flex gap-4 my-8'>
                ...
                <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                    ...
                    <div className='flex flex-col sm:ml-4 font-medium'>
                        ...
                        <p className='text-neural-400 text-base'>{currency}{dashboardData.totalRevenue}</p>
                    </div>
                </div>
            </div>
            {/* Recent Booking */}
