...
const NewsLetter = () => {
    return (
        <div className="flex flex-col items-center max-w-7xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            <Title title="Stay Inspired" subTitle="Join our Newsletter and be the first to discover new destination, exclusive offers, and travel inspiration."></Title>
