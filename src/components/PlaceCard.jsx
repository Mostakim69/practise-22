...
const PlaceCard = ({tour, index}) => {
    return (
        <Link to={'/tours/'+ tour._id} onClick={()=>scrollTo(0,0)} key={tour._id}
        className='relative max-w-70 w-full rounded-xl overflow-hidden bg-white text-gray-500/90 shadows-[0px_4px_4px_rgba(0,0,0,0.05)]'>
            ...
            <div className='p-4 pt-5'>
                <div className='flex items-center justify-between'>
                    <p className='font-playfair text-xl font-medium text-gray-800'>{tour.place.name}</p>
                ...
                <div className='flex items-center justify-between mt-4'>
                    <p><span className='text-xl text-gray-800'>${tour.pricePerDay}</span>/day</p>
